...
<?php foreach ($news as $n) : ?>
        <tr><td><h3>สำนักงานสาธารณสุขจังหวัดชุมพร</h3></tr></td>
    <tr><td><h3>รายงานการจ่ายเงินเดือน <?=$n['prename'];?><?=$n['fname'];?>  <?=$n['lname'];?></h3></tr></td>
<?php endforeach ?>
    </table>
    <br/>
<center>  
    
    <table align='center' border='1'  class="table-striped table-bordered table-hover">
        <?php foreach ($news as $n) : ?>
...
<br/>
<table align='center'>
    <tr><td><p>© Copyright - 2017 Information Technology of Chumphon Public Health Center</p></tr></td>
<tr><td><p>© Consultants : Teacher MIMI & BIGPOC</p></tr></td>
</table>
</body>
</html>